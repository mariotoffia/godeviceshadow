...
* 🔄 *Shadow State Management* - Handles both reported and desired states with configurable merging strategies
...
|💾 *dynamodbpersistence*
|Persistence implementation for Amazon DynamoDB. https://github.com/mariotoffia/godeviceshadow/tree/main/persistence/dynamodbpersistence[README]

|📡 *dynamodbnotifier*
|DynamoDB Streams based event notification system. https://github.com/mariotoffia/godeviceshadow/tree/main/notify/dynamodbnotifier[README]

|🔤 *selectlang*
|DSL for creating notification selection filters. https://github.com/mariotoffia/godeviceshadow/tree/main/notify/selectlang[README]
|===
